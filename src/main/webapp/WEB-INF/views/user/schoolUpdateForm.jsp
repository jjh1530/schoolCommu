	...
	<div class="container">
		<div class="card shadow mb-4">
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				<h6 class="m-0 font-weight-bold">정보 등록</h6>
			</div>
			<div class="panel-body">
				<form id="updateForm" name="updateForm" method="post">
					...
					<div class="bg-light rounded h-100 p-4">
						<div class="col-sm-11" style="display: inline-block;">
						<label for="elementarySchool">초등학교</label> 
					...
					<div class="bg-light rounded h-100 p-4">
						<div class="col-sm-11" style="display: inline-block;">
						<label for="middleSchool">중학교</label> 
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div id="schoolList" style="background-color: white; overflow: scroll; height: 500px; padding: 10px;"></div>
